...
import { LatestCameraCardConfig } from './types';
...
@customElement('latestcamera-card-editor')
export class LatestCameraCardEditor extends LitElement implements LovelaceCardEditor {
  @property({ attribute: false }) public hass?: HomeAssistant;
  @internalProperty() private _config?: LatestCameraCardConfig;
